...
The R2 for the regression is 0.02055. Based on the R2, 'year' and 'ice_off_doy' are not strongly related and the R2 shows that they
...
sunapee <- add_predictions(sunapee, fit)
sunapee <- add_residuals(sunapee, fit)
```
